...
4. В DevTools проверьте запрос `POST /api/images/fetch`: поле `imageUrl` должно приходить как финальный `https://fastly.picsum.photos/...hmac=...` (валидный, не фейковый) и вставка не должна падать с `400/502`.
